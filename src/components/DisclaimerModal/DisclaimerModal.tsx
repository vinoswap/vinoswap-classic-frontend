...
const DisclaimerModal: React.FC<DisclaimerModal> = ({
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          <p> With great pleasure we would like to invite you to the launch
              of Omakase Bar!
          </p>
          <p> Omakase Bar will be the home of our new frontend, and provides
              an interface for all interactions with the VinoSwap protocol.
          </p>
          <p> Development will be on going, and vinoswapclassic will still
